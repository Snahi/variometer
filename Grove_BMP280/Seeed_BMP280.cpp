...
bool BMP280::init(int i2c_addr) {
	...
	byte F4value = (0x2 & 0x7) << 5 | (0x16 & 0x7) << 2 | (0x3 & 0x3);
    writeRegister(BMP280_REG_CONTROL, /*0x3F*/ F4value);
	byte F5value = (0 & 0x07) << 5 | (0x16 & 0x07) << 2 | (0 & 0x03);
	writeRegister(BMP280_REG_CONFIG, F5value);
    return true;
}
